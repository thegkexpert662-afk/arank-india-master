            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                return Row(
                  children: [
                    if (!compact)
                      _MasterSidebar(onOpen: (screen) => _open(context, screen)),
                    Expanded(
                                ...
                                const Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4),
                                      Text(
                                        'ARank India • Global Control Center',
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                _StatCard(
                                  ...
                                  stream: MasterDataService.students(),
                                ),
                                _StatCard(
                                  label: 'Active Admins',
                            ...
                            Wrap(
                              ...
                              children: [
                                _ActionCard(
                                  ...
                                  onTap: () => _open(context, const AdminManagementScreen()),
                                ),
                                _ActionCard(
                                  title: 'Institute Management',
                                  icon: Icons.account_balance_rounded,
                                  onTap: () => _open(context, const InstituteManagementScreen()),
                                ),
                                _ActionCard(
                                  title: 'Student Management',
                                  icon: Icons.school_outlined,
                                  onTap: () => _open(context, const StudentManagementScreen()),
                                ),
                                _ActionCard(
                                  title: 'Service Management',
                                  icon: Icons.tune_rounded,
                                  onTap: () => _open(context, const ServiceManagementScreen()),
                                ),
                                _ActionCard(
                                  title: 'Audit Logs',
                                  icon: Icons.fact_check_outlined,
                                  onTap: () => _open(context, const AuditLogsScreen()),
                                ),
                              ],
                            ),
                          ],
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const Center(
          child: Text('ARank India', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
        ),
        const Center(
          child: Text(
            'MASTER ADMIN',
        ...
        ListTile(
          ...
          onTap: () => onOpen(const AdminManagementScreen()),
        ),
        ListTile(
          leading: const Icon(Icons.account_balance_rounded),
          title: const Text('Institute Management'),
          onTap: () => onOpen(const InstituteManagementScreen()),
        ),
        ListTile(
          leading: const Icon(Icons.groups_rounded),
          title: const Text('Student Management'),
          onTap: () => onOpen(const StudentManagementScreen()),
        ),
        ListTile(
          leading: const Icon(Icons.tune_rounded),
          title: const Text('Service Management'),
          onTap: () => onOpen(const ServiceManagementScreen()),
        ),
        ListTile(
          leading: const Icon(Icons.fact_check_outlined),
          title: const Text('Audit Logs'),
          onTap: () => onOpen(const AuditLogsScreen()),
        ),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF607889)),
          ),
        ],
      ),
    );
...
class _NavItem extends StatelessWidget {
  const _NavItem({required this.icon, required this.title, this.selected = false, this.onTap});
  final IconData icon;
  final String title;
  final bool selected;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        leading: Icon(
          icon,
          color: selected ? const Color(0xFF1677D2) : const Color(0xFF667B8B),
        ),
        title: Text(
          title,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          label,
                          style: const TextStyle(fontSize: 13, color: Color(0xFF647789)),
                        ),
